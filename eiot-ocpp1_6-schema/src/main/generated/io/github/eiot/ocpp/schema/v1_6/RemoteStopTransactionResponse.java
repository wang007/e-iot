...
public class RemoteStopTransactionResponse {
    ...
    public RemoteStopTransactionResponse withStatus(RemoteStopTransactionResponse.Status status) {
        this.status = status;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RemoteStopTransactionResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RemoteStopTransactionResponse) == false) {
            return false;
        }
        RemoteStopTransactionResponse rhs = ((RemoteStopTransactionResponse) other);
