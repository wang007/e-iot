...
public class DiagnosticsStatusNotificationRequest {
    ...
    public DiagnosticsStatusNotificationRequest withStatus(DiagnosticsStatusNotificationRequest.Status status) {
        this.status = status;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(DiagnosticsStatusNotificationRequest.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DiagnosticsStatusNotificationRequest) == false) {
            return false;
        }
        DiagnosticsStatusNotificationRequest rhs = ((DiagnosticsStatusNotificationRequest) other);
