...
public class ChargingSchedulePeriod__1 {
    ...
    public ChargingSchedulePeriod__1 withStartPeriod(int startPeriod) {
        this.startPeriod = startPeriod;
        return this;
    }
    ...
    public ChargingSchedulePeriod__1 withLimit(double limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ChargingSchedulePeriod__1 withNumberPhases(int numberPhases) {
        this.numberPhases = numberPhases;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ChargingSchedulePeriod__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChargingSchedulePeriod__1) == false) {
            return false;
        }
        ChargingSchedulePeriod__1 rhs = ((ChargingSchedulePeriod__1) other);
