...
public class NetworkConnectionProfile {
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((this.ocppTransport == rhs.ocppTransport)||((this.ocppTransport!= null)&&this.ocppTransport.equals(rhs.ocppTransport)))&&(this.securityProfile == rhs.securityProfile))&&((this.vpn == rhs.vpn)||((this.vpn!= null)&&this.vpn.equals(rhs.vpn))))&&((this.ocppVersion == rhs.ocppVersion)||((this.ocppVersion!= null)&&this.ocppVersion.equals(rhs.ocppVersion))))&&((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData))))&&((this.ocppCsmsUrl == rhs.ocppCsmsUrl)||((this.ocppCsmsUrl!= null)&&this.ocppCsmsUrl.equals(rhs.ocppCsmsUrl))))&&((this.apn == rhs.apn)||((this.apn!= null)&&this.apn.equals(rhs.apn))))&&(this.messageTimeout == rhs.messageTimeout))&&((this.ocppInterface == rhs.ocppInterface)||((this.ocppInterface!= null)&&this.ocppInterface.equals(rhs.ocppInterface))));
    }
