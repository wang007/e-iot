...
public class SetMonitoringResult {
    ...
    public SetMonitoringResult withId(int id) {
        this.id = id;
        return this;
    }
    ...
    public SetMonitoringResult withSeverity(int severity) {
        this.severity = severity;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((this.severity == rhs.severity)&&((this.component == rhs.component)||((this.component!= null)&&this.component.equals(rhs.component))))&&((this.statusInfo == rhs.statusInfo)||((this.statusInfo!= null)&&this.statusInfo.equals(rhs.statusInfo))))&&((this.variable == rhs.variable)||((this.variable!= null)&&this.variable.equals(rhs.variable))))&&((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData))))&&(this.id == rhs.id))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
