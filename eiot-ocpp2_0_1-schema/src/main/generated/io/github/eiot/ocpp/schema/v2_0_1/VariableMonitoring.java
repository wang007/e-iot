...
public class VariableMonitoring {
    ...
    public boolean equals(Object other) {
        ...
        return ((((((this.severity == rhs.severity)&&((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData))))&&(this.id == rhs.id))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&(Double.doubleToLongBits(this.value) == Double.doubleToLongBits(rhs.value)))&&(this.transaction == rhs.transaction));
    }
