...
public class TransactionEventResponse {
    ...
    public boolean equals(Object other) {
        ...
        return ((((((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData)))&&(this.chargingPriority == rhs.chargingPriority))&&((this.idTokenInfo == rhs.idTokenInfo)||((this.idTokenInfo!= null)&&this.idTokenInfo.equals(rhs.idTokenInfo))))&&(Double.doubleToLongBits(this.totalCost) == Double.doubleToLongBits(rhs.totalCost)))&&((this.updatedPersonalMessage == rhs.updatedPersonalMessage)||((this.updatedPersonalMessage!= null)&&this.updatedPersonalMessage.equals(rhs.updatedPersonalMessage))));
    }
