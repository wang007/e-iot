...
public class ChargingSchedule {
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((this.duration == rhs.duration)&&(Double.doubleToLongBits(this.minChargingRate) == Double.doubleToLongBits(rhs.minChargingRate)))&&((this.startSchedule == rhs.startSchedule)||((this.startSchedule!= null)&&this.startSchedule.equals(rhs.startSchedule))))&&((this.chargingSchedulePeriod == rhs.chargingSchedulePeriod)||((this.chargingSchedulePeriod!= null)&&this.chargingSchedulePeriod.equals(rhs.chargingSchedulePeriod))))&&((this.salesTariff == rhs.salesTariff)||((this.salesTariff!= null)&&this.salesTariff.equals(rhs.salesTariff))))&&((this.chargingRateUnit == rhs.chargingRateUnit)||((this.chargingRateUnit!= null)&&this.chargingRateUnit.equals(rhs.chargingRateUnit))))&&((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData))))&&(this.id == rhs.id));
    }
