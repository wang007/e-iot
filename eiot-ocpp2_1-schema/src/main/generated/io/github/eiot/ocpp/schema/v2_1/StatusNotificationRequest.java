...
public class StatusNotificationRequest {
    ...
    public boolean equals(Object other) {
        ...
        return (((((this.evseId == rhs.evseId)&&((this.connectorStatus == rhs.connectorStatus)||((this.connectorStatus!= null)&&this.connectorStatus.equals(rhs.connectorStatus))))&&((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData))))&&(this.connectorId == rhs.connectorId))&&((this.timestamp == rhs.timestamp)||((this.timestamp!= null)&&this.timestamp.equals(rhs.timestamp))));
    }
