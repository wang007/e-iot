...
public class VariableCharacteristics {
    ...
    public VariableCharacteristics withMaxElements(int maxElements) {
        this.maxElements = maxElements;
        return this;
    }
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+ this.maxElements);
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((this.unit == rhs.unit)||((this.unit!= null)&&this.unit.equals(rhs.unit)))&&((this.valuesList == rhs.valuesList)||((this.valuesList!= null)&&this.valuesList.equals(rhs.valuesList))))&&(this.supportsMonitoring == rhs.supportsMonitoring))&&(Double.doubleToLongBits(this.maxLimit) == Double.doubleToLongBits(rhs.maxLimit)))&&((this.dataType == rhs.dataType)||((this.dataType!= null)&&this.dataType.equals(rhs.dataType))))&&(this.maxElements == rhs.maxElements))&&(Double.doubleToLongBits(this.minLimit) == Double.doubleToLongBits(rhs.minLimit)))&&((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData))));
    }
