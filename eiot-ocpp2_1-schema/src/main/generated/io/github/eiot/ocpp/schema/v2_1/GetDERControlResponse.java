...
public class GetDERControlResponse {
    ...
    public GetDERControlResponse withStatus(DERControlStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public GetDERControlResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
    ...
    public GetDERControlResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GetDERControlResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetDERControlResponse) == false) {
            return false;
        }
        GetDERControlResponse rhs = ((GetDERControlResponse) other);
