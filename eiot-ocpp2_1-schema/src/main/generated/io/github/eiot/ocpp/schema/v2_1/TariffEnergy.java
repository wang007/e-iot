...
public class TariffEnergy {
    ...
    @Valid
    @NotNull
    private List<TariffEnergyPrice> prices = new ArrayList<TariffEnergyPrice>();
    ...
    public TariffEnergy withPrices(List<TariffEnergyPrice> prices) {
        this.prices = prices;
        return this;
    }
    ...
    public TariffEnergy withTaxRates(List<TaxRate> taxRates) {
        this.taxRates = taxRates;
        return this;
    }
    ...
    public TariffEnergy withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TariffEnergy.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("prices");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TariffEnergy) == false) {
            return false;
        }
        TariffEnergy rhs = ((TariffEnergy) other);
