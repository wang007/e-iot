...
public class ClearDERControlResponse {
    ...
    public ClearDERControlResponse withStatus(DERControlStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ClearDERControlResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
    ...
    public ClearDERControlResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ClearDERControlResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ClearDERControlResponse) == false) {
            return false;
        }
        ClearDERControlResponse rhs = ((ClearDERControlResponse) other);
