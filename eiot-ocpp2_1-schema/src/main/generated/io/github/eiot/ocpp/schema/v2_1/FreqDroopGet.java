...
public class FreqDroopGet {
    ...
    public FreqDroopGet withFreqDroop(FreqDroop freqDroop) {
        this.freqDroop = freqDroop;
        return this;
    }
    ...
    public FreqDroopGet withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public FreqDroopGet withIsDefault(boolean isDefault) {
        this.isDefault = isDefault;
        return this;
    }
    ...
    public FreqDroopGet withIsSuperseded(boolean isSuperseded) {
        this.isSuperseded = isSuperseded;
        return this;
    }
    ...
    public FreqDroopGet withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(FreqDroopGet.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("freqDroop");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FreqDroopGet) == false) {
            return false;
        }
        FreqDroopGet rhs = ((FreqDroopGet) other);
        return (((((this.isDefault == rhs.isDefault)&&((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.freqDroop == rhs.freqDroop)||((this.freqDroop!= null)&&this.freqDroop.equals(rhs.freqDroop))))&&(this.isSuperseded == rhs.isSuperseded));
    }
