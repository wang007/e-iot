...
public class AdjustPeriodicEventStreamResponse {
    ...
    public AdjustPeriodicEventStreamResponse withStatus(GenericStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public AdjustPeriodicEventStreamResponse withStatusInfo(StatusInfo statusInfo) {
        this.statusInfo = statusInfo;
        return this;
    }
    ...
    public AdjustPeriodicEventStreamResponse withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AdjustPeriodicEventStreamResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AdjustPeriodicEventStreamResponse) == false) {
            return false;
        }
        AdjustPeriodicEventStreamResponse rhs = ((AdjustPeriodicEventStreamResponse) other);
