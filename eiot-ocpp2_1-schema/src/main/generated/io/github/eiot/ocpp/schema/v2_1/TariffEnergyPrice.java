...
public class TariffEnergyPrice {
    ...
    public TariffEnergyPrice withPriceKwh(double priceKwh) {
        this.priceKwh = priceKwh;
        return this;
    }
    ...
    public TariffEnergyPrice withConditions(TariffConditions conditions) {
        this.conditions = conditions;
        return this;
    }
    ...
    public TariffEnergyPrice withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TariffEnergyPrice.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("priceKwh");
        sb.append('=');
        sb.append(this.priceKwh);
        sb.append(',');
    ...
    public int hashCode() {
        int result = 1;
        result = ((result* 31)+((int)(Double.doubleToLongBits(this.priceKwh)^(Double.doubleToLongBits(this.priceKwh)>>> 32))));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TariffEnergyPrice) == false) {
            return false;
        }
        TariffEnergyPrice rhs = ((TariffEnergyPrice) other);
        return (((Double.doubleToLongBits(this.priceKwh) == Double.doubleToLongBits(rhs.priceKwh))&&((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData))))&&((this.conditions == rhs.conditions)||((this.conditions!= null)&&this.conditions.equals(rhs.conditions))));
    }
