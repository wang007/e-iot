...
public class ClearMonitoringResult {
    ...
    public ClearMonitoringResult withId(int id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData)))&&(this.id == rhs.id))&&((this.statusInfo == rhs.statusInfo)||((this.statusInfo!= null)&&this.statusInfo.equals(rhs.statusInfo))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
