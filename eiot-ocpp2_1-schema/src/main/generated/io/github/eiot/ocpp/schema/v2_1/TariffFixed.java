...
public class TariffFixed {
    ...
    @Valid
    @NotNull
    private List<TariffFixedPrice> prices = new ArrayList<TariffFixedPrice>();
    ...
    public TariffFixed withPrices(List<TariffFixedPrice> prices) {
        this.prices = prices;
        return this;
    }
    ...
    public TariffFixed withTaxRates(List<TaxRate> taxRates) {
        this.taxRates = taxRates;
        return this;
    }
    ...
    public TariffFixed withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TariffFixed.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("prices");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TariffFixed) == false) {
            return false;
        }
        TariffFixed rhs = ((TariffFixed) other);
