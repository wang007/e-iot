...
public class SignCertificateRequest {
    ...
    public SignCertificateRequest withHashRootCertificate(CertificateHashData hashRootCertificate) {
        this.hashRootCertificate = hashRootCertificate;
        return this;
    }
    ...
    public SignCertificateRequest withRequestId(int requestId) {
        this.requestId = requestId;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("hashRootCertificate");
        sb.append('=');
        sb.append(((this.hashRootCertificate == null)?"<null>":this.hashRootCertificate));
        sb.append(',');
        sb.append("requestId");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.hashRootCertificate == null)? 0 :this.hashRootCertificate.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return ((((((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData)))&&((this.csr == rhs.csr)||((this.csr!= null)&&this.csr.equals(rhs.csr))))&&((this.hashRootCertificate == rhs.hashRootCertificate)||((this.hashRootCertificate!= null)&&this.hashRootCertificate.equals(rhs.hashRootCertificate))))&&(this.requestId == rhs.requestId))&&((this.certificateType == rhs.certificateType)||((this.certificateType!= null)&&this.certificateType.equals(rhs.certificateType))));
    }
