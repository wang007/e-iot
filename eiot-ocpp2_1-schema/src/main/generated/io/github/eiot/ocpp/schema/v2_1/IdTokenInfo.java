...
public class IdTokenInfo {
    ...
    public IdTokenInfo withChargingPriority(int chargingPriority) {
        this.chargingPriority = chargingPriority;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((this.evseId == rhs.evseId)||((this.evseId!= null)&&this.evseId.equals(rhs.evseId)))&&((this.language2 == rhs.language2)||((this.language2 != null)&&this.language2 .equals(rhs.language2))))&&((this.language1 == rhs.language1)||((this.language1 != null)&&this.language1 .equals(rhs.language1))))&&((this.cacheExpiryDateTime == rhs.cacheExpiryDateTime)||((this.cacheExpiryDateTime!= null)&&this.cacheExpiryDateTime.equals(rhs.cacheExpiryDateTime))))&&(this.chargingPriority == rhs.chargingPriority))&&((this.personalMessage == rhs.personalMessage)||((this.personalMessage!= null)&&this.personalMessage.equals(rhs.personalMessage))))&&((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData))))&&((this.groupIdToken == rhs.groupIdToken)||((this.groupIdToken!= null)&&this.groupIdToken.equals(rhs.groupIdToken))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
