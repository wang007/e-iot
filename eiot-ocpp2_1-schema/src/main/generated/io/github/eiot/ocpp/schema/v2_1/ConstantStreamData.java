...
public class ConstantStreamData {
    ...
    public ConstantStreamData withId(int id) {
        this.id = id;
        return this;
    }
    ...
    public ConstantStreamData withParams(PeriodicEventStreamParams params) {
        this.params = params;
        return this;
    }
    ...
    public ConstantStreamData withVariableMonitoringId(int variableMonitoringId) {
        this.variableMonitoringId = variableMonitoringId;
        return this;
    }
    ...
    public ConstantStreamData withCustomData(CustomData customData) {
        this.customData = customData;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ConstantStreamData.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
        sb.append(this.id);
        sb.append(',');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ConstantStreamData) == false) {
            return false;
        }
        ConstantStreamData rhs = ((ConstantStreamData) other);
        return (((((this.customData == rhs.customData)||((this.customData!= null)&&this.customData.equals(rhs.customData)))&&(this.id == rhs.id))&&((this.params == rhs.params)||((this.params!= null)&&this.params.equals(rhs.params))))&&(this.variableMonitoringId == rhs.variableMonitoringId));
    }
