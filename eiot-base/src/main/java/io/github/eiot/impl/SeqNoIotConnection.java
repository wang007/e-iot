 ...
 */
public abstract class SeqNoIotConnection extends IotConnectionBase {

    protected static final Logger logger = LoggerFactory.getLogger(SeqNoIotConnection.class);
