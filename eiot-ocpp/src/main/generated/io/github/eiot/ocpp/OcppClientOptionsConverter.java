...
/**
 * Converter and mapper for {@link io.github.eiot.ocpp.OcppClientOptions}.
 * NOTE: This class has been automatically generated from the {@link io.github.eiot.ocpp.OcppClientOptions} original class using Vert.x codegen.
 */
public class OcppClientOptionsConverter {


  private static final Base64.Decoder BASE64_DECODER = JsonUtil.BASE64_DECODER;
  private static final Base64.Encoder BASE64_ENCODER = JsonUtil.BASE64_ENCODER;

   static void fromJson(Iterable<java.util.Map.Entry<String, Object>> json, OcppClientOptions obj) {
   ...
   static void toJson(OcppClientOptions obj, JsonObject json) {
    toJson(obj, json.getMap());
  }

   static void toJson(OcppClientOptions obj, java.util.Map<String, Object> json) {
