...
public interface Ocpp2_1Command {
    ...
    CommandDef<BootNotificationResponse> BootNotificationResponse = COMMAND_PROTOCOL.createAndRegister("BootNotificationResponse", io.github.eiot.ocpp.schema.BootNotificationResponse.class);
    RequestCommandDef<BootNotificationRequest, BootNotificationResponse> BootNotificationRequest =
            COMMAND_PROTOCOL.createAndRegister("BootNotification", io.github.eiot.ocpp.schema.BootNotificationRequest.class, BootNotificationResponse);
